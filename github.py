...
class GitaddMod(loader.Module):
    ...
    def __init__(self):
        self.config = loader.ModuleConfig("GH_TOKEN", "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", lambda m: self.strings("cfg_token", m),
            "GH_USERNAME", "Kolchak01", lambda m: self.strings("cfg_gh_user", m),
            "GH_REPO", "modules", lambda m: self.strings("cfg_gh_repo", m))
